...
// Adding a wrapper component to handle spacing properly
const Movie = ({ movie, index = 0 }) => {
  ...
  return (
    // Outer container with margin to ensure content is below navbar
    <div className="movie-container" style={{ marginTop: '80px', paddingTop: '2rem' }}>
      <m.div
        variants={cardVariants}
        initial="hidden"
        animate="visible"
        whileHover="hover"
        className="group perspective-1000 relative z-10"
      >
